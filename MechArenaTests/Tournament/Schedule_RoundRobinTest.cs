...
namespace MechArenaTests.Tournament
{
    ...
    public class Schedule_RoundRobinTest
    {
        ...
        public void TestTiebreakerSimple()
        {
            ...
            srr.ReportResult(new MatchResult(srr.NextMatch(), comps[2], 0, 0));
            srr.ReportResult(new MatchResult(srr.NextMatch(), comps[1], 0, 0));
        ...
        public void TestTiebreakerModerate()
        {
            ...
            srr.ReportResult(new MatchResult(srr.NextMatch(), comps[2], 0, 0));
            srr.ReportResult(new MatchResult(srr.NextMatch(), comps[0], 0, 0));
            srr.ReportResult(new MatchResult(srr.NextMatch(), comps[3], 0, 0));
            srr.ReportResult(new MatchResult(srr.NextMatch(), comps[0], 0, 0));
            srr.ReportResult(new MatchResult(srr.NextMatch(), comps[1], 0, 0));
        ...
        public void TestTiebreakerComplex()
        {
            ...
            srr.ReportResult(new MatchResult(srr.NextMatch(), comps[1], 0, 0));
            srr.ReportResult(new MatchResult(srr.NextMatch(), comps[0], 0, 0));
            srr.ReportResult(new MatchResult(srr.NextMatch(), comps[4], 0, 0));
            srr.ReportResult(new MatchResult(srr.NextMatch(), comps[0], 0, 0));
            srr.ReportResult(new MatchResult(srr.NextMatch(), comps[2], 0, 0));
            srr.ReportResult(new MatchResult(srr.NextMatch(), comps[1], 0, 0));
            srr.ReportResult(new MatchResult(srr.NextMatch(), comps[2], 0, 0));
