...
namespace MechArena
{
    public static class ArenaBuilder
    {
        ...
        public static Arena BuildFixedTestArena(int width, int height)
        {
            int seed = 100;
            ...
            IMap arenaMap = Map.Create(
                new RogueSharp.MapCreation.CaveMapCreationStrategy<Map>(width, height, 45, 4, 3, new DotNetRandom(seed)));
        ...
        public static Arena BuildFixedAIVersusAIArena(int width, int height)
        {
            int seed = 50;
            ...
            IMap arenaMap = Map.Create(
                new RogueSharp.MapCreation.CaveMapCreationStrategy<Map>(width, height, 45, 4, 3, new DotNetRandom(seed)));
            Arena arena = new Arena(mech1, mech2, arenaMap);
